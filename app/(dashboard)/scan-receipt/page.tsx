...
export default function ReceiptPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <PageHeader
        title="Receipt"
        description="Record ingredient purchases from supplier receipts"
      />
          ...
          >
            <CardContent className="flex flex-col items-center gap-3 pt-6 pb-6">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Upload a photo to extract items
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="flex flex-col gap-6">
          <Alert className="border-emerald-200 bg-emerald-50/50">
            ...
            <AlertDescription className="text-emerald-700">
              Receipt processed successfully! {receiptItems.length} items
              totaling ${totalAmount.toFixed(2)} have been recorded.
            </AlertDescription>
          </Alert>
            ...
            <CardContent>
              <div className="flex flex-col gap-4">
                {receiptItems.map((item, index) => (
                  <div
                    key={item.id}
                    className="p-4 bg-muted/30 rounded-lg flex flex-col gap-3"
                  >
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <Input
                        ...
                        placeholder="e.g. Flour 25kg bag"
                      />
                    </div>
            ...
            >
              {isConfirming ? (
                ...
                <>
                  ...
                  Confirm Receipt ({receiptItems.length} items)
                </>
              )}
            </Button>
          </div>
      ...
      {/* Instructions (only on mode selection) */}
      {!mode && !confirmSuccess && (
        <div className="mt-6 p-4 bg-muted/50 rounded-lg">
          <h3 className="font-medium mb-2">How it works</h3>
          <ul className="text-sm text-muted-foreground flex flex-col gap-1">
            <li>
              <strong>Manual Entry</strong> - Type in each item from your
              receipt by hand. Best for short receipts.
            </li>
            <li>
              <strong>Scan Receipt</strong> - Upload a photo and the system
              will extract items automatically. Review and correct before
              confirming.
            </li>
          </ul>
        </div>
